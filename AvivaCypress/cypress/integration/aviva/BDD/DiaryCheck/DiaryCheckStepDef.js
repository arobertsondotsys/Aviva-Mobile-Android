...
Given('Check Diary Chaser function',()=>
{ 
  Global_Stuff.Server()
  ...
  Global_Stuff.policySelectButton()
   ...
   //Select Diary
    ...
    cy.wait(1500)
    //cy.get('#ctl00_ContentPlaceHolder1_DocumentGrid_ctl05_IsRequired').click()
    //cy.wait(1500)
    ...
    cy.wait(1500)
    //cy.get('#ctl00_ContentPlaceHolder1_DocumentGrid_ctl12_IsRequired').click()
    ...
    cy.wait(1500)
    //cy.get('#ctl00_ContentPlaceHolder1_DocumentGrid_ctl05_IsReceived').click()
    //cy.wait(1500)
    ...
    cy.wait(1500)
    //cy.get('#ctl00_ContentPlaceHolder1_DocumentGrid_ctl12_IsReceived').click()
