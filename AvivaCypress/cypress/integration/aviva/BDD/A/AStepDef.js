...
Given('Agent can purchase a policy via back office',()=>
{ 
  Global_Stuff.Server()
    ...
    Global_Stuff.coverStartHaveHomeInsTrue()
    Global_Stuff.coverStartHaveCarInsTrue()
    Global_Stuff.coverStartPromoCode()
    ...
    Global_Stuff.notes()
    Global_Stuff.quotePageAddOpenDrive()
    Global_Stuff.quotePageExcess125()
    Global_Stuff.quotePageAddJourneywise()
    Global_Stuff.quotePagePNCDStepBack()
    //cy.pause()
    ...
    Global_Stuff.postQuote3OtherCar()
    Global_Stuff.postQuote3OtherHome()
