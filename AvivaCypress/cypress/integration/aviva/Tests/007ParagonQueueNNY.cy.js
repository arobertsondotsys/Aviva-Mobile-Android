...
describe('Policy Purchase with NNY', () => {
    it('should complete the process of purchasing a policy with NNY preferences', () => {
        Server.Server()
        ...
        YourInsHistoryAndIncepDetsPage.postQuote3PostCertFalse()
        ...
        BOAction.notes()
        ThankYouPage.retreiveParagonPolicyNumber2()
        ...
        // Select policy and Documents 
        BOAction.livePoliciesBTN()
        BOAction.selectActionDiaryWithParagonPolicyNumber2()
