...
describe('Agent can upload document', () => {
    it('should complete the process of uploading a document', () => {
        ...
        cy.getAndWait('#ctl00_ContentPlaceHolder1_FileUpload').selectFile("C:/Users/a.robertson/OneDrive - MCL Insurance/Desktop/Cypress Projects/Aviva/AvivaCypress/cypress/support/Example.jpg", {force: true})
