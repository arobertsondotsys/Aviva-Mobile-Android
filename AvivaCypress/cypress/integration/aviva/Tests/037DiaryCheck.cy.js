...
describe('Check Diary Chaser function', () => {
    it('should complete the process of checking the diary chaser function', () => {
        ...
        BOAction.tickProofOfDriverMembAsRequired()
        BOAction.tickDrivingExpAsRequired()
        BOAction.tickProofOfIgnitionAsRequired()
        BOAction.tickEngineersReportAsRequired()
        BOAction.tickMedReportFormAsRequired()
        ...
        BOAction.tickEngineersReportAsReceived()
        BOAction.tickMedReportFormAsReceived()
        ...
        // cy.wait(1500)
        // cy.getAndWait('#ctl00_ContentPlaceHolder1_DocumentGrid_ctl05_IsReceived').click()
        // cy.wait(1500)
        ...
        // cy.wait(1500)
        // cy.getAndWait('#ctl00_ContentPlaceHolder1_DocumentGrid_ctl12_IsReceived').click()
        // cy.wait(1500)
