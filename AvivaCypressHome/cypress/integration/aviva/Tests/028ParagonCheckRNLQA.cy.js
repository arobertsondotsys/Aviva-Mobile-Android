...
describe('Agent purchase home policy with docs set to post at RNL', () => {
  it('should allow an agent to purchase a home policy with docs set to post at RNL', () => {
    ...
    BOAction.notes()
    ThankYouScreen.retreiveParagonPolicyNumber9()
    ...
    // Back date policy
    BOAction.policyToolsAgePolicyWithParagonPolicyNumber9()
    BOAction.agePolicy()
    ...
    BOAction.inviteRenewalParagon9()
    ...
    BOAction.livePoliciesBTN()
    BOAction.selectActionRenewalWithParagonPolicyNumber9()
