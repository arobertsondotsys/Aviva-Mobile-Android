...
describe('Agent purchase home policy renewal as PIF from DD', () => {
  it('should allow an agent to purchase a home policy renewal as PIF from DD', () => {
    ...
    Global_stuff.selectActionDPAWithPolicyNumber()
    Global_stuff.optOutRollover()
