...
describe('Agent purchase home policy with docs set to post at RNL MTA', () => {
  it('should allow an agent to purchase a home policy with docs set to post at RNL MTA', () => {
    ...
    BOAction.notes()
    ThankYouScreen.retreiveParagonPolicyNumber11()
    ...
    // Back date policy
    BOAction.policyToolsAgePolicyWithParagonPolicyNumber11()
    BOAction.agePolicy()
    ...
    BOAction.inviteRenewalParagon11()
    ...
    BOAction.livePoliciesBTN()
    BOAction.selectActionRenewalWithParagonPolicyNumber11()
    ...
    BOAction.livePoliciesBTN()
    BOAction.homePolicyTab()
    BOAction.selectActionMakeADJWithParagonPolicyNumber11()
