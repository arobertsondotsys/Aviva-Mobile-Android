...
async function setupNodeEvents(on, config) {
  ...
  const qaSpecPattern = [
     ...
     'cypress/integration/aviva/Tests/AgentNBAddSpecifiedRNLPurchQA.cy.js',
     ...
     'cypress/integration/aviva/Tests/CustNBAddSpecifiedRNLPurchQA.cy.js',
  ...
  const demoSpecPattern = [
    ...
    'cypress/integration/aviva/Tests/AgentNBAddSpecifiedRNLPurch.cy.js',
    'cypress/integration/aviva/Tests/AgentPurch.cy.js',
    ...
    'cypress/integration/aviva/Tests/CustNBAddSpecifiedRNLPurch.cy.js',
    'cypress/integration/aviva/Tests/AgentPurchJointProv.cy.js',
