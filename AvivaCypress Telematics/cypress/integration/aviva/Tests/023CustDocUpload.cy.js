...
describe('Customer can upload a document', () => {
    it('should upload a document successfully', () => {
        ...
        cy.get('input[type="file"]').selectFile("C:/Users/a.robertson/OneDrive - MCL Insurance/Desktop/Cypress Projects/Aviva/AvivaCypress Telematics/cypress/support/Example.jpg", {force:true})
